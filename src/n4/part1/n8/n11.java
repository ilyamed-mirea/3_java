...
public class n11 {
    public static void main(String[] args) {
        ...
        // bad line System.out.println(s1.getRadius());
        ...
        // bad line Shape s2 = new Shape(); - abstract
        Shape s3 = new Rectangle("RED", false, 1.0, 2.0);
        System.out.println(s3);
        System.out.println(s3.getArea());
        System.out.println(s3.getPerimeter());
        System.out.println(s3.getColor());
        //bad line System.out.println(s3.getA());
        //bad line Rectangle r1 = (Rectangle)s3; //downcast
//        System.out.println(r1);
//        System.out.println(r1.getArea());
//        System.out.println(r1.getColor());
//        System.out.println(r1.getA());
        Shape s4 = new Square("Green",true,6.6);//Upcast
        System.out.println(s4);
        System.out.println(s4.getArea());
        System.out.println(s4.getColor());
        //bad line  System.out.println(s4.getA());
...
// Downcast Rectangle r2 к Square
        ...
        System.out.println(sq1.getA());
        System.out.println(sq1.getB());*/
    }
}
